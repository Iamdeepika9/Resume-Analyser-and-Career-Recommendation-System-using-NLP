...
connection = pymysql.connect(host='localhost', user='root', password='P@ssword')
...
def run():
    ...
    choice = st.sidebar.selectbox("Choose from the dropdown:", activities)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if recommended_skills:
                    ...
                    linkedin_url = generate_linkedin_url(recommended_skills)
        ...
        if st.button('Login'):
            if ad_user == 'admin' and ad_password == 'admin':
                ...
                field_counts.columns = ['Field', 'Count']  # Rename columns for clarity
